...
INSERT INTO Disciplina (id, nome, ano, curso, createdAt, UpdateAt) VALUES
...
(126, 'Língua Inglesa', 2, 4, '2023-07-10 15"createdAt", "UpdateAt":07:35', '2023-07-10 15:07:35'),
...
ALTER TABLE Disciplina
  ADD PRIMARY KEY (id),
  ADD CONSTRAINT fk_disciplina_curso FOREIGN KEY (curso) REFERENCES Curso(id);

ALTER TABLE Prova
  ADD PRIMARY KEY (id),
  ADD CONSTRAINT fk_prova_curso FOREIGN KEY (curso) REFERENCES Curso(id),
  ADD CONSTRAINT fk_prova_turma FOREIGN KEY (turma) REFERENCES Turma(id),
  ADD CONSTRAINT fk_prova_disciplina FOREIGN KEY (disciplina) REFERENCES Disciplina(id),
  ADD CONSTRAINT fk_prova_usuario FOREIGN KEY (usuario) REFERENCES Usuario(id);

CREATE INDEX idx_curso ON Prova (curso);
CREATE INDEX idx_turma ON Prova (turma);
CREATE INDEX idx_disciplina ON Prova (disciplina);
CREATE INDEX idx_usuario ON Prova (usuario);

ALTER TABLE Usuario
  ADD PRIMARY KEY (id);

CREATE INDEX idx_curso ON Usuario (curso);
CREATE INDEX idx_turma ON Usuario (turma);
...
ALTER TABLE Disciplina
  ADD CONSTRAINT disciplina_fk_curso
  FOREIGN KEY (curso)
  REFERENCES Curso (id);

ALTER TABLE Prova
  ADD CONSTRAINT prova_fk_curso
  FOREIGN KEY (curso)
  REFERENCES Curso (id);

ALTER TABLE Prova
  ADD CONSTRAINT prova_fk_turma
  FOREIGN KEY (turma)
  REFERENCES Turma (id);

ALTER TABLE Prova
  ADD CONSTRAINT prova_fk_disciplina
  FOREIGN KEY (disciplina)
  REFERENCES Disciplina (id);

ALTER TABLE Prova
  ADD CONSTRAINT prova_fk_usuario
  FOREIGN KEY (usuario)
  REFERENCES Usuario (id);

ALTER TABLE Usuario
  ADD CONSTRAINT usuario_fk_curso
  FOREIGN KEY (curso)
  REFERENCES Curso (id);

ALTER TABLE Usuario
  ADD CONSTRAINT usuario_fk_turma
  FOREIGN KEY (turma)
  REFERENCES Turma (id);